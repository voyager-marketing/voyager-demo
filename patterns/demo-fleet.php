...
<div class="wp-block-group alignfull vo-section vo-section--raised vo-reveal is-layout-constrained">
    ...
    <h2 class="wp-block-heading has-text-align-center has-xl-font-size" style="letter-spacing:-0.03em;margin-bottom:var(--wp--preset--spacing--60)"><?php echo esc_html_x( 'The Fleet at a Glance', 'fleet stats heading', 'voyager-demo' ); ?></h2>
    <!-- /wp:heading -->
    ...
    <div class="wp-block-columns alignwide">
        ...
        <div class="wp-block-column has-bg-raised-background-color has-background" style="border-color:#E2E0EA;border-width:1px;border-radius:12px;padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--40)">
            ...
            <p class="has-text-align-center has-fg-4-color has-text-color has-sm-font-size"><?php echo esc_html_x( 'Client Sites', 'fleet stat label', 'voyager-demo' ); ?></p>
            <!-- /wp:paragraph -->
        ...
        <div class="wp-block-column has-bg-raised-background-color has-background" style="border-color:#E2E0EA;border-width:1px;border-radius:12px;padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--40)">
            ...
            <!-- wp:paragraph {"align":"center","textColor":"accent","style":{"typography":{"fontWeight":"700","fontSize":"2.5rem","letterSpacing":"-0.04em"}},"metadata":{"bindings":{"content":{"source":"voyager/pulse","args":{"key":"ability_count"}}}}} -->
            ...
            <!-- wp:paragraph {"align":"center","textColor":"fg-4","fontSize":"sm"} -->
            <p class="has-text-align-center has-fg-4-color has-text-color has-sm-font-size"><?php echo esc_html_x( 'AI Abilities', 'fleet stat label', 'voyager-demo' ); ?></p>
            <!-- /wp:paragraph -->
        ...
        <div class="wp-block-column has-bg-raised-background-color has-background" style="border-color:#E2E0EA;border-width:1px;border-radius:12px;padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--40)">
            ...
            <!-- wp:paragraph {"align":"center","textColor":"fg-4","fontSize":"sm"} -->
            <p class="has-text-align-center has-fg-4-color has-text-color has-sm-font-size"><?php echo esc_html_x( 'Content Freshness', 'fleet stat label', 'voyager-demo' ); ?></p>
            <!-- /wp:paragraph -->
...
<div class="wp-block-group alignfull vo-section vo-section--raised vo-reveal is-layout-constrained">
    ...
    <h2 class="wp-block-heading has-text-align-center has-xl-font-size" style="letter-spacing:-0.03em"><?php echo esc_html_x( 'Design once. Push to 50 sites simultaneously.', 'fleet pattern cloud heading', 'voyager-demo' ); ?></h2>
    <!-- /wp:heading -->
    ...
    <div class="wp-block-columns alignwide">
        ...
        <div class="wp-block-column has-bg-raised-background-color has-background" style="border-left-color:var(--wp--preset--color--accent);border-left-width:4px;border-radius:12px;padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--40)">
            ...
            <!-- wp:heading {"level":3,"fontSize":"lg","textColor":"accent"} -->
            <h3 class="wp-block-heading has-accent-color has-text-color has-lg-font-size"><?php echo esc_html_x( 'Design', 'fleet pattern cloud step', 'voyager-demo' ); ?></h3>
            <!-- /wp:heading -->

            <!-- wp:paragraph {"textColor":"fg-4","fontSize":"sm"} -->
            <p class="has-fg-4-color has-text-color has-sm-font-size"><?php echo esc_html_x( 'Create patterns in the Voyager Blocks plugin. Test locally with live preview, design tokens, and theme integration.', 'fleet pattern cloud step detail', 'voyager-demo' ); ?></p>
            <!-- /wp:paragraph -->
        ...
        <div class="wp-block-column has-bg-raised-background-color has-background" style="border-left-color:var(--wp--preset--color--accent-bright);border-left-width:4px;border-radius:12px;padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--40)">
            ...
            <!-- wp:heading {"level":3,"fontSize":"lg","textColor":"accent-bright"} -->
            <h3 class="wp-block-heading has-accent-bright-color has-text-color has-lg-font-size"><?php echo esc_html_x( 'Sync', 'fleet pattern cloud step', 'voyager-demo' ); ?></h3>
            <!-- /wp:heading -->

            <!-- wp:paragraph {"textColor":"fg-4","fontSize":"sm"} -->
            <p class="has-fg-4-color has-text-color has-sm-font-size"><?php echo esc_html_x( 'Pattern Cloud API distributes to all fleet sites via JSON manifest. Each site pulls only the patterns it needs.', 'fleet pattern cloud step detail', 'voyager-demo' ); ?></p>
            <!-- /wp:paragraph -->
        ...
        <div class="wp-block-column has-bg-raised-background-color has-background" style="border-left-color:var(--wp--preset--color--accent);border-left-width:4px;border-radius:12px;padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--40)">
            ...
            <!-- wp:heading {"level":3,"fontSize":"lg","textColor":"accent"} -->
            <h3 class="wp-block-heading has-accent-color has-text-color has-lg-font-size"><?php echo esc_html_x( 'Update', 'fleet pattern cloud step', 'voyager-demo' ); ?></h3>
            <!-- /wp:heading -->

            <!-- wp:paragraph {"textColor":"fg-4","fontSize":"sm"} -->
            <p class="has-fg-4-color has-text-color has-sm-font-size"><?php echo esc_html_x( 'Change the source pattern, every site refreshes within 24 hours. No deploys, no tickets, no version drift.', 'fleet pattern cloud step detail', 'voyager-demo' ); ?></p>
            <!-- /wp:paragraph -->
    ...
    <div class="wp-block-group has-bg-raised-background-color has-background is-layout-flex" style="border-radius:8px;margin-top:var(--wp--preset--spacing--50);padding-top:var(--wp--preset--spacing--30);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--30);padding-left:var(--wp--preset--spacing--40)">
        ...
        <!-- wp:paragraph {"textColor":"fg-4","fontSize":"sm"} -->
        <p class="has-fg-4-color has-text-color has-sm-font-size"><?php echo esc_html_x( 'Patterns in the cloud right now:', 'fleet pattern count label', 'voyager-demo' ); ?></p>
        <!-- /wp:paragraph -->
...
<div class="wp-block-group alignfull vo-reveal is-layout-constrained" style="background:linear-gradient(135deg, #1B1F3B 0%, #2A2F52 100%);padding-top:var(--wp--preset--spacing--80);padding-right:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--80);padding-left:var(--wp--preset--spacing--60)">
    ...
    <h2 class="wp-block-heading has-text-align-center has-xl-font-size" style="color:var(--wp--preset--color--fg-1);letter-spacing:-0.03em;margin-bottom:var(--wp--preset--spacing--30)"><?php echo esc_html_x( 'Binding Health Monitor', 'fleet binding health heading', 'voyager-demo' ); ?></h2>
    <!-- /wp:heading -->
...
<div class="wp-block-group alignfull vo-section vo-section--raised vo-reveal is-layout-constrained">
    ...
    <!-- wp:heading {"textAlign":"center","fontSize":"xl","style":{"typography":{"letterSpacing":"-0.03em"}}} -->
    <h2 class="wp-block-heading has-text-align-center has-xl-font-size" style="letter-spacing:-0.03em"><?php echo esc_html_x( 'MCP — The Universal Remote', 'fleet mcp heading', 'voyager-demo' ); ?></h2>
    <!-- /wp:heading -->
    ...
    <div class="wp-block-columns alignwide">
        ...
        <div class="wp-block-column has-bg-raised-background-color has-background" style="border-color:#E2E0EA;border-width:1px;border-radius:12px;padding-top:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--30)">
            <!-- wp:heading {"level":4,"textColor":"accent","fontSize":"md"} -->
            <h4 class="wp-block-heading has-accent-color has-text-color has-md-font-size"><?php echo esc_html_x( 'Content', 'fleet mcp domain', 'voyager-demo' ); ?></h4>
            <!-- /wp:heading -->
            ...
            <!-- /wp:paragraph -->
            <!-- wp:paragraph {"textColor":"fg-4","fontSize":"sm"} -->
            <p class="has-fg-4-color has-text-color has-sm-font-size"><?php echo esc_html_x( 'create-post, update-post, notion-sync', 'fleet mcp tools', 'voyager-demo' ); ?></p>
            <!-- /wp:paragraph -->
        </div>
        <!-- /wp:column -->
        ...
        <div class="wp-block-column has-bg-raised-background-color has-background" style="border-color:#E2E0EA;border-width:1px;border-radius:12px;padding-top:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--30)">
            <!-- wp:heading {"level":4,"textColor":"accent","fontSize":"md"} -->
            <h4 class="wp-block-heading has-accent-color has-text-color has-md-font-size"><?php echo esc_html_x( 'SEO', 'fleet mcp domain', 'voyager-demo' ); ?></h4>
            <!-- /wp:heading -->
            <!-- wp:paragraph {"textColor":"fg-4","style":{"typography":{"fontSize":"0.8rem","fontFamily":"monospace"}}} -->
            ...
            <!-- /wp:paragraph -->
            <!-- wp:paragraph {"textColor":"fg-4","fontSize":"sm"} -->
            <p class="has-fg-4-color has-text-color has-sm-font-size"><?php echo esc_html_x( 'audit-page, generate-schema, pseo-batch', 'fleet mcp tools', 'voyager-demo' ); ?></p>
            <!-- /wp:paragraph -->
        </div>
        <!-- /wp:column -->
        ...
        <div class="wp-block-column has-bg-raised-background-color has-background" style="border-color:#E2E0EA;border-width:1px;border-radius:12px;padding-top:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--30)">
            <!-- wp:heading {"level":4,"textColor":"accent","fontSize":"md"} -->
            <h4 class="wp-block-heading has-accent-color has-text-color has-md-font-size"><?php echo esc_html_x( 'Leads', 'fleet mcp domain', 'voyager-demo' ); ?></h4>
            <!-- /wp:heading -->
            <!-- wp:paragraph {"textColor":"fg-4","style":{"typography":{"fontSize":"0.8rem","fontFamily":"monospace"}}} -->
            ...
            <!-- /wp:paragraph -->
            <!-- wp:paragraph {"textColor":"fg-4","fontSize":"sm"} -->
            <p class="has-fg-4-color has-text-color has-sm-font-size"><?php echo esc_html_x( 'get-leads, lead-velocity, coverage-report', 'fleet mcp tools', 'voyager-demo' ); ?></p>
            <!-- /wp:paragraph -->
        </div>
        <!-- /wp:column -->
    ...
    <div class="wp-block-columns alignwide">
        ...
        <div class="wp-block-column has-bg-raised-background-color has-background" style="border-color:#E2E0EA;border-width:1px;border-radius:12px;padding-top:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--30)">
            <!-- wp:heading {"level":4,"textColor":"accent","fontSize":"md"} -->
            <h4 class="wp-block-heading has-accent-color has-text-color has-md-font-size"><?php echo esc_html_x( 'Analytics', 'fleet mcp domain', 'voyager-demo' ); ?></h4>
            <!-- /wp:heading -->
            <!-- wp:paragraph {"textColor":"fg-4","style":{"typography":{"fontSize":"0.8rem","fontFamily":"monospace"}}} -->
            ...
            <!-- /wp:paragraph -->
            <!-- wp:paragraph {"textColor":"fg-4","fontSize":"sm"} -->
            <p class="has-fg-4-color has-text-color has-sm-font-size"><?php echo esc_html_x( 'site-health, block-usage, performance-check', 'fleet mcp tools', 'voyager-demo' ); ?></p>
            <!-- /wp:paragraph -->
        </div>
        <!-- /wp:column -->
        ...
        <div class="wp-block-column has-bg-raised-background-color has-background" style="border-color:#E2E0EA;border-width:1px;border-radius:12px;padding-top:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--30)">
            <!-- wp:heading {"level":4,"textColor":"accent","fontSize":"md"} -->
            <h4 class="wp-block-heading has-accent-color has-text-color has-md-font-size"><?php echo esc_html_x( 'Social', 'fleet mcp domain', 'voyager-demo' ); ?></h4>
            <!-- /wp:heading -->
            <!-- wp:paragraph {"textColor":"fg-4","style":{"typography":{"fontSize":"0.8rem","fontFamily":"monospace"}}} -->
            <p class="has-fg-4-color has-text-color" style="font-family:monospace;font-size:0.8rem"><?php echo esc_html_x( '8 tools', 'fleet mcp count', 'voyager-demo' ); ?></p>
            <!-- /wp:paragraph -->
            <!-- wp:paragraph {"textColor":"fg-4","fontSize":"sm"} -->
            <p class="has-fg-4-color has-text-color has-sm-font-size"><?php echo esc_html_x( 'create-post, schedule-post, get-analytics', 'fleet mcp tools', 'voyager-demo' ); ?></p>
            <!-- /wp:paragraph -->
        </div>
        <!-- /wp:column -->
        ...
        <div class="wp-block-column has-bg-raised-background-color has-background" style="border-color:#E2E0EA;border-width:1px;border-radius:12px;padding-top:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--30)">
            <!-- wp:heading {"level":4,"textColor":"accent","fontSize":"md"} -->
            <h4 class="wp-block-heading has-accent-color has-text-color has-md-font-size"><?php echo esc_html_x( 'Site Management', 'fleet mcp domain', 'voyager-demo' ); ?></h4>
            <!-- /wp:heading -->
            <!-- wp:paragraph {"textColor":"fg-4","style":{"typography":{"fontSize":"0.8rem","fontFamily":"monospace"}}} -->
            <p class="has-fg-4-color has-text-color" style="font-family:monospace;font-size:0.8rem"><?php echo esc_html_x( '8 tools', 'fleet mcp count', 'voyager-demo' ); ?></p>
            <!-- /wp:paragraph -->
            <!-- wp:paragraph {"textColor":"fg-4","fontSize":"sm"} -->
            <p class="has-fg-4-color has-text-color has-sm-font-size"><?php echo esc_html_x( 'update-plugin, check-health, clear-cache', 'fleet mcp tools', 'voyager-demo' ); ?></p>
            <!-- /wp:paragraph -->
        </div>
        <!-- /wp:column -->
    ...
    <div class="wp-block-columns alignwide">
        ...
        <div class="wp-block-column has-bg-raised-background-color has-background" style="border-color:#E2E0EA;border-width:1px;border-radius:12px;padding-top:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--30)">
            <!-- wp:heading {"level":4,"textColor":"accent","fontSize":"md"} -->
            <h4 class="wp-block-heading has-accent-color has-text-color has-md-font-size"><?php echo esc_html_x( 'Fleet', 'fleet mcp domain', 'voyager-demo' ); ?></h4>
            <!-- /wp:heading -->
            <!-- wp:paragraph {"textColor":"fg-4","style":{"typography":{"fontSize":"0.8rem","fontFamily":"monospace"}}} -->
            <p class="has-fg-4-color has-text-color" style="font-family:monospace;font-size:0.8rem"><?php echo esc_html_x( '6 tools', 'fleet mcp count', 'voyager-demo' ); ?></p>
            <!-- /wp:paragraph -->
            <!-- wp:paragraph {"textColor":"fg-4","fontSize":"sm"} -->
            <p class="has-fg-4-color has-text-color has-sm-font-size"><?php echo esc_html_x( 'fleet-status, binding-audit, pattern-sync', 'fleet mcp tools', 'voyager-demo' ); ?></p>
            <!-- /wp:paragraph -->
        </div>
        <!-- /wp:column -->
        ...
        <div class="wp-block-column has-bg-raised-background-color has-background" style="border-color:#E2E0EA;border-width:1px;border-radius:12px;padding-top:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--30)">
            <!-- wp:heading {"level":4,"textColor":"accent","fontSize":"md"} -->
            <h4 class="wp-block-heading has-accent-color has-text-color has-md-font-size"><?php echo esc_html_x( 'AI', 'fleet mcp domain', 'voyager-demo' ); ?></h4>
            <!-- /wp:heading -->
            <!-- wp:paragraph {"textColor":"fg-4","style":{"typography":{"fontSize":"0.8rem","fontFamily":"monospace"}}} -->
            <p class="has-fg-4-color has-text-color" style="font-family:monospace;font-size:0.8rem"><?php echo esc_html_x( '7 tools', 'fleet mcp count', 'voyager-demo' ); ?></p>
            <!-- /wp:paragraph -->
            <!-- wp:paragraph {"textColor":"fg-4","fontSize":"sm"} -->
            <p class="has-fg-4-color has-text-color has-sm-font-size"><?php echo esc_html_x( 'generate-content, run-ability, list-abilities', 'fleet mcp tools', 'voyager-demo' ); ?></p>
            <!-- /wp:paragraph -->
        </div>
        <!-- /wp:column -->
        ...
        <div class="wp-block-column has-bg-raised-background-color has-background" style="border-color:#E2E0EA;border-width:1px;border-radius:12px;padding-top:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--30)">
            <!-- wp:heading {"level":4,"textColor":"accent","fontSize":"md"} -->
            <h4 class="wp-block-heading has-accent-color has-text-color has-md-font-size"><?php echo esc_html_x( 'Publishing', 'fleet mcp domain', 'voyager-demo' ); ?></h4>
            <!-- /wp:heading -->
            <!-- wp:paragraph {"textColor":"fg-4","style":{"typography":{"fontSize":"0.8rem","fontFamily":"monospace"}}} -->
            ...
            <!-- /wp:paragraph -->
            <!-- wp:paragraph {"textColor":"fg-4","fontSize":"sm"} -->
            <p class="has-fg-4-color has-text-color has-sm-font-size"><?php echo esc_html_x( 'publish-queue, schedule-content, notion-push', 'fleet mcp tools', 'voyager-demo' ); ?></p>
            <!-- /wp:paragraph -->
        </div>
        <!-- /wp:column -->
...
<div class="wp-block-group alignfull vo-section vo-section--raised vo-reveal is-layout-constrained">
    ...
    <!-- wp:heading {"textAlign":"center","fontSize":"xl","style":{"typography":{"letterSpacing":"-0.03em"}}} -->
    <h2 class="wp-block-heading has-text-align-center has-xl-font-size" style="letter-spacing:-0.03em"><?php echo esc_html_x( 'Managed Agents', 'fleet agents heading', 'voyager-demo' ); ?></h2>
    <!-- /wp:heading -->
    ...
    <div class="wp-block-columns alignwide">
        ...
        <div class="wp-block-column has-bg-raised-background-color has-background" style="border-color:#E2E0EA;border-width:1px;border-radius:12px;padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--40)">
            ...
            <!-- wp:heading {"level":3,"fontSize":"lg","textColor":"fg-1"} -->
            <h3 class="wp-block-heading has-fg-1-color has-text-color has-lg-font-size"><?php echo esc_html_x( 'Content Machine', 'fleet agent name', 'voyager-demo' ); ?></h3>
            <!-- /wp:heading -->
            ...
            <p class="has-fg-4-color has-text-color has-sm-font-size" style="margin-top:var(--wp--preset--spacing--20)"><?php echo esc_html_x( 'Generates strategic content briefs from keyword gaps, competitor analysis, and topical authority maps.', 'fleet agent purpose', 'voyager-demo' ); ?></p>
            <!-- /wp:paragraph -->
        ...
        <div class="wp-block-column has-bg-raised-background-color has-background" style="border-color:#E2E0EA;border-width:1px;border-radius:12px;padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--40)">
            ...
            <!-- wp:heading {"level":3,"fontSize":"lg","textColor":"fg-1"} -->
            <h3 class="wp-block-heading has-fg-1-color has-text-color has-lg-font-size"><?php echo esc_html_x( 'SEO Blitz', 'fleet agent name', 'voyager-demo' ); ?></h3>
            <!-- /wp:heading -->
            ...
            <!-- wp:paragraph {"textColor":"fg-4","fontSize":"sm","style":{"spacing":{"margin":{"top":"var:preset|spacing|20"}}}} -->
            <p class="has-fg-4-color has-text-color has-sm-font-size" style="margin-top:var(--wp--preset--spacing--20)"><?php echo esc_html_x( 'Expands the pSEO matrix — discovers new city/service combos and generates unique landing pages at scale.', 'fleet agent purpose', 'voyager-demo' ); ?></p>
            <!-- /wp:paragraph -->
        ...
        <div class="wp-block-column has-bg-raised-background-color has-background" style="border-color:#E2E0EA;border-width:1px;border-radius:12px;padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--40)">
            ...
            <!-- wp:heading {"level":3,"fontSize":"lg","textColor":"fg-1"} -->
            <h3 class="wp-block-heading has-fg-1-color has-text-color has-lg-font-size"><?php echo esc_html_x( 'SEO Page Builder', 'fleet agent name', 'voyager-demo' ); ?></h3>
            <!-- /wp:heading -->
            ...
            <!-- wp:paragraph {"textColor":"fg-4","fontSize":"sm","style":{"spacing":{"margin":{"top":"var:preset|spacing|20"}}}} -->
            <p class="has-fg-4-color has-text-color has-sm-font-size" style="margin-top:var(--wp--preset--spacing--20)"><?php echo esc_html_x( 'Fills service area content gaps with unique, data-enriched pages — local stats, FAQs, testimonials.', 'fleet agent purpose', 'voyager-demo' ); ?></p>
            <!-- /wp:paragraph -->
    ...
    <div class="wp-block-columns alignwide">
        ...
        <div class="wp-block-column has-bg-raised-background-color has-background" style="border-color:#E2E0EA;border-width:1px;border-radius:12px;padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--40)">
            ...
            <!-- wp:heading {"level":3,"fontSize":"lg","textColor":"fg-1"} -->
            <h3 class="wp-block-heading has-fg-1-color has-text-color has-lg-font-size"><?php echo esc_html_x( 'Lead Intelligence', 'fleet agent name', 'voyager-demo' ); ?></h3>
            <!-- /wp:heading -->
            ...
            <!-- wp:paragraph {"textColor":"fg-4","fontSize":"sm","style":{"spacing":{"margin":{"top":"var:preset|spacing|20"}}}} -->
            <p class="has-fg-4-color has-text-color has-sm-font-size" style="margin-top:var(--wp--preset--spacing--20)"><?php echo esc_html_x( 'Coverage analysis and velocity tracking across all fleet sites. Spots trends before clients ask.', 'fleet agent purpose', 'voyager-demo' ); ?></p>
            <!-- /wp:paragraph -->
        ...
        <div class="wp-block-column has-bg-raised-background-color has-background" style="border-color:#E2E0EA;border-width:1px;border-radius:12px;padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--40)">
            ...
            <!-- wp:heading {"level":3,"fontSize":"lg","textColor":"fg-1"} -->
            <h3 class="wp-block-heading has-fg-1-color has-text-color has-lg-font-size"><?php echo esc_html_x( 'Site QA', 'fleet agent name', 'voyager-demo' ); ?></h3>
            <!-- /wp:heading -->
            ...
            <!-- wp:paragraph {"textColor":"fg-4","fontSize":"sm","style":{"spacing":{"margin":{"top":"var:preset|spacing|20"}}}} -->
            <p class="has-fg-4-color has-text-color has-sm-font-size" style="margin-top:var(--wp--preset--spacing--20)"><?php echo esc_html_x( 'PHP lint, JSON validation, template and pattern integrity checks across every site daily.', 'fleet agent purpose', 'voyager-demo' ); ?></p>
            <!-- /wp:paragraph -->
        ...
        <div class="wp-block-column has-bg-raised-background-color has-background" style="border-color:#E2E0EA;border-width:1px;border-radius:12px;padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--40)">
            ...
            <!-- wp:heading {"level":3,"fontSize":"lg","textColor":"fg-1"} -->
            <h3 class="wp-block-heading has-fg-1-color has-text-color has-lg-font-size"><?php echo esc_html_x( 'Fleet Binding QA', 'fleet agent name', 'voyager-demo' ); ?></h3>
            <!-- /wp:heading -->
            ...
            <!-- wp:paragraph {"textColor":"fg-4","fontSize":"sm","style":{"spacing":{"margin":{"top":"var:preset|spacing|20"}}}} -->
            <p class="has-fg-4-color has-text-color has-sm-font-size" style="margin-top:var(--wp--preset--spacing--20)"><?php echo esc_html_x( 'Fleet-wide binding health — empty fields, stale Notion caches, broken sources, API errors.', 'fleet agent purpose', 'voyager-demo' ); ?></p>
            <!-- /wp:paragraph -->
