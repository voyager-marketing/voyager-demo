 ...
 */
?>
<?php if ( function_exists( 'voyager_demo_binding_live' ) && ! voyager_demo_binding_live( 'voyager/conditional' ) ) : ?>
...
<p class="alignwide has-warn-color has-text-color has-sm-font-size" style="padding-top:var(--wp--preset--spacing--3);padding-bottom:var(--wp--preset--spacing--3)">Heads up: this pattern demonstrates the voyager/conditional binding source, which is switched off on this install &#8212; bound values below show their static fallbacks until it is connected. Nothing is mocked.</p>
<!-- /wp:paragraph -->
<?php endif; ?>
...
<!-- ============================================================ -->
<!-- wp:group {"align":"full","className":"vo-starfield vo-reveal","style":{"spacing":{"padding":{"top":"var:preset|spacing|9","bottom":"var:preset|spacing|8","left":"var:preset|spacing|7","right":"var:preset|spacing|7"},"margin":{"top":"0","bottom":"0"}}},"backgroundColor":"bg-canvas","layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull vo-starfield vo-reveal has-bg-canvas-background-color has-background is-layout-constrained" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--9);padding-right:var(--wp--preset--spacing--7);padding-bottom:var(--wp--preset--spacing--8);padding-left:var(--wp--preset--spacing--7)">

    <!-- wp:group {"align":"wide","style":{"spacing":{"blockGap":"var:preset|spacing|6"}},"layout":{"type":"constrained"}} -->
    <div class="wp-block-group alignwide is-layout-constrained">
        ...
        <div class="wp-block-group vo-grid-60-35" style="margin-top:var(--wp--preset--spacing--6)">
            ...
            <h1 class="wp-block-heading has-fg-1-color has-text-color has-mono-font-family has-5-xl-font-size" style="margin-top:0;margin-bottom:0;font-weight:500;line-height:1;letter-spacing:-0.03em"><?php
            printf(
...
<div class="wp-block-group alignfull vo-section vo-reveal is-layout-constrained">
    ...
    <div class="wp-block-group alignwide is-layout-constrained">
        ...
        <div class="wp-block-group vo-grid-60-35" style="margin-top:var(--wp--preset--spacing--6)">
            ...
            <h2 class="wp-block-heading has-fg-1-color has-text-color has-mono-font-family has-3-xl-font-size" style="margin-top:0;margin-bottom:0;font-weight:500;line-height:1.05;letter-spacing:-0.02em"><?php
            printf(
        ...
        <!-- wp:group {"style":{"spacing":{"margin":{"top":"var:preset|spacing|6"},"blockGap":"0"},"border":{"color":"var:preset|color|border-hair","width":"1px"}},"layout":{"type":"constrained"}} -->
        <div class="wp-block-group" style="border-color:var(--wp--preset--color--border-hair);border-width:1px;margin-top:var(--wp--preset--spacing--6)">

            <!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|5","bottom":"var:preset|spacing|5","left":"var:preset|spacing|5","right":"var:preset|spacing|5"},"blockGap":"var:preset|spacing|5"},"border":{"bottom":{"color":"var:preset|color|border-hair","width":"1px"}}},"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"space-between","verticalAlignment":"center"}} -->
            <div class="wp-block-group is-layout-flex" style="border-bottom-color:var(--wp--preset--color--border-hair);border-bottom-width:1px;padding-top:var(--wp--preset--spacing--5);padding-right:var(--wp--preset--spacing--5);padding-bottom:var(--wp--preset--spacing--5);padding-left:var(--wp--preset--spacing--5)">
            ...
            <!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|5","bottom":"var:preset|spacing|5","left":"var:preset|spacing|5","right":"var:preset|spacing|5"},"blockGap":"var:preset|spacing|5"}},"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"space-between","verticalAlignment":"center"}} -->
            <div class="wp-block-group is-layout-flex" style="padding-top:var(--wp--preset--spacing--5);padding-right:var(--wp--preset--spacing--5);padding-bottom:var(--wp--preset--spacing--5);padding-left:var(--wp--preset--spacing--5)">
                <!-- wp:paragraph {"style":{"typography":{"fontSize":"11px","letterSpacing":"0.08em","textTransform":"uppercase","fontWeight":"500"},"spacing":{"margin":{"top":"0","bottom":"0"}}},"textColor":"fg-4","fontFamily":"mono"} -->
...
<div class="wp-block-group alignfull vo-section vo-reveal is-layout-constrained">
    ...
    <div class="wp-block-group alignwide is-layout-constrained">
        ...
        <div class="wp-block-group vo-grid-60-35" style="margin-top:var(--wp--preset--spacing--6)">
            ...
            <!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|6","bottom":"var:preset|spacing|6","left":"var:preset|spacing|6","right":"var:preset|spacing|6"},"blockGap":"var:preset|spacing|5"},"border":{"color":"var:preset|color|border-hair","width":"1px"}},"backgroundColor":"bg-raised","layout":{"type":"constrained"}} -->
            <div class="wp-block-group has-border-color has-bg-raised-background-color has-background" style="border-color:var(--wp--preset--color--border-hair);border-width:1px;padding-top:var(--wp--preset--spacing--6);padding-right:var(--wp--preset--spacing--6);padding-bottom:var(--wp--preset--spacing--6);padding-left:var(--wp--preset--spacing--6)">
                ...
                <!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|5"},"blockGap":"0"},"border":{"top":{"color":"var:preset|color|border-hair","width":"1px"}}},"layout":{"type":"constrained"}} -->
                <div class="wp-block-group" style="border-top-color:var(--wp--preset--color--border-hair);border-top-width:1px;padding-top:var(--wp--preset--spacing--5)">
...
<div class="wp-block-group alignfull vo-section vo-reveal is-layout-constrained">
    ...
    <div class="wp-block-group alignwide is-layout-constrained">
        ...
        <!-- wp:columns {"align":"wide","style":{"spacing":{"margin":{"top":"var:preset|spacing|6"},"blockGap":{"left":"var:preset|spacing|5","top":"var:preset|spacing|5"}}}} -->
        <div class="wp-block-columns alignwide" style="margin-top:var(--wp--preset--spacing--6)">

            <!-- wp:column {"style":{"spacing":{"padding":{"top":"var:preset|spacing|6","right":"var:preset|spacing|6","bottom":"var:preset|spacing|6","left":"var:preset|spacing|6"},"blockGap":"var:preset|spacing|3"},"border":{"color":"var:preset|color|border-hair","width":"1px","radius":"2px"}}} -->
            <div class="wp-block-column has-border-color" style="border-color:var(--wp--preset--color--border-hair);border-width:1px;border-radius:2px;padding-top:var(--wp--preset--spacing--6);padding-right:var(--wp--preset--spacing--6);padding-bottom:var(--wp--preset--spacing--6);padding-left:var(--wp--preset--spacing--6)">
                ...
                <!-- wp:paragraph {"style":{"typography":{"fontWeight":"500","lineHeight":"1.15","letterSpacing":"-0.01em"},"spacing":{"margin":{"top":"var:preset|spacing|3","bottom":"0"}}},"textColor":"fg-1","fontSize":"xl","fontFamily":"mono","metadata":{"bindings":{"content":{"source":"voyager/ab-test","args":{"variants":"Grow Faster With Data|Scale Your Digital Presence|Marketing That Actually Works","test_id":"playground-headline"}}}}} -->
                <p class="has-fg-1-color has-text-color has-mono-font-family has-xl-font-size" style="margin-top:var(--wp--preset--spacing--3);margin-bottom:0;font-weight:500;line-height:1.15;letter-spacing:-0.01em"><?php echo esc_html_x( 'Grow Faster With Data', 'ab fallback', 'voyager-demo' ); ?></p>
                <!-- /wp:paragraph -->

                <!-- wp:paragraph {"style":{"typography":{"lineHeight":"1.6"},"spacing":{"margin":{"top":"var:preset|spacing|5","bottom":"0"}}},"textColor":"fg-4","fontSize":"sm","fontFamily":"body"} -->
                <p class="has-fg-4-color has-text-color has-body-font-family has-sm-font-size" style="margin-top:var(--wp--preset--spacing--5);margin-bottom:0;line-height:1.6"><?php echo esc_html_x( '3 variants. Cookie-hashed. Deterministic per visitor.', 'ab note', 'voyager-demo' ); ?></p>
                <!-- /wp:paragraph -->
            ...
            <div class="wp-block-column has-border-color" style="border-color:var(--wp--preset--color--border-hair);border-width:1px;border-radius:2px;padding-top:var(--wp--preset--spacing--6);padding-right:var(--wp--preset--spacing--6);padding-bottom:var(--wp--preset--spacing--6);padding-left:var(--wp--preset--spacing--6)">
                ...
                <p class="has-fg-1-color has-text-color has-mono-font-family has-xl-font-size" style="margin-top:var(--wp--preset--spacing--3);margin-bottom:0;font-weight:500;line-height:1.15;letter-spacing:-0.01em"><?php echo esc_html_x( 'Get Started Free', 'ab fallback', 'voyager-demo' ); ?></p>
                <!-- /wp:paragraph -->

                <!-- wp:paragraph {"style":{"typography":{"lineHeight":"1.6"},"spacing":{"margin":{"top":"var:preset|spacing|5","bottom":"0"}}},"textColor":"fg-4","fontSize":"sm","fontFamily":"body"} -->
                <p class="has-fg-4-color has-text-color has-body-font-family has-sm-font-size" style="margin-top:var(--wp--preset--spacing--5);margin-bottom:0;line-height:1.6"><?php echo esc_html_x( '3 variants. Same hash, different test_id = independent assignment.', 'ab note', 'voyager-demo' ); ?></p>
                <!-- /wp:paragraph -->
            ...
            <div class="wp-block-column has-border-color" style="border-color:var(--wp--preset--color--border-hair);border-width:1px;border-radius:2px;padding-top:var(--wp--preset--spacing--6);padding-right:var(--wp--preset--spacing--6);padding-bottom:var(--wp--preset--spacing--6);padding-left:var(--wp--preset--spacing--6)">
                ...
                <p class="has-fg-1-color has-text-color has-mono-font-family has-xl-font-size" style="margin-top:var(--wp--preset--spacing--3);margin-bottom:0;font-weight:500;line-height:1.15;letter-spacing:-0.01em"><?php echo esc_html_x( 'Zero third-party tools needed', 'ab fallback', 'voyager-demo' ); ?></p>
                <!-- /wp:paragraph -->

                <!-- wp:paragraph {"style":{"typography":{"lineHeight":"1.6"},"spacing":{"margin":{"top":"var:preset|spacing|5","bottom":"0"}}},"textColor":"fg-4","fontSize":"sm","fontFamily":"body"} -->
                <p class="has-fg-4-color has-text-color has-body-font-family has-sm-font-size" style="margin-top:var(--wp--preset--spacing--5);margin-bottom:0;line-height:1.6"><?php echo esc_html_x( '3 variants. All tests use the same visitor cookie but produce independent results.', 'ab note', 'voyager-demo' ); ?></p>
                <!-- /wp:paragraph -->
...
<div class="wp-block-group alignfull vo-section vo-reveal is-layout-constrained">
    ...
    <div class="wp-block-group alignwide is-layout-constrained">
        ...
        <div class="wp-block-group" style="border-color:var(--wp--preset--color--border-hair);border-width:1px;margin-top:var(--wp--preset--spacing--6)">
            ...
            <!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|5","bottom":"var:preset|spacing|5","left":"var:preset|spacing|5","right":"var:preset|spacing|5"},"blockGap":"var:preset|spacing|3"},"border":{"bottom":{"color":"var:preset|color|border-hair","width":"1px"}}},"layout":{"type":"constrained"}} -->
            <div class="wp-block-group" style="border-bottom-color:var(--wp--preset--color--border-hair);border-bottom-width:1px;padding-top:var(--wp--preset--spacing--5);padding-right:var(--wp--preset--spacing--5);padding-bottom:var(--wp--preset--spacing--5);padding-left:var(--wp--preset--spacing--5)">
                <!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|5"}},"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"space-between","verticalAlignment":"top"}} -->
                ...
                <!-- /wp:group -->
                <!-- wp:paragraph {"style":{"typography":{"fontWeight":"500","lineHeight":"1.3"},"spacing":{"margin":{"top":"var:preset|spacing|3","bottom":"0"}}},"textColor":"fg-1","fontSize":"md","fontFamily":"mono","metadata":{"bindings":{"content":{"source":"voyager/conditional","args":{"rule":"hours","value":"9-17","content":"We're open right now! Let's talk.","else":"We're closed, but leave a message."}}}}} -->
                <p class="has-fg-1-color has-text-color has-mono-font-family has-md-font-size" style="margin-top:var(--wp--preset--spacing--3);margin-bottom:0;font-weight:500;line-height:1.3"><?php echo esc_html_x( 'Checking hours...', 'conditional fallback', 'voyager-demo' ); ?></p>
                <!-- /wp:paragraph -->
            </div>
            <!-- /wp:group -->
            ...
            <div class="wp-block-group" style="border-bottom-color:var(--wp--preset--color--border-hair);border-bottom-width:1px;padding-top:var(--wp--preset--spacing--5);padding-right:var(--wp--preset--spacing--5);padding-bottom:var(--wp--preset--spacing--5);padding-left:var(--wp--preset--spacing--5)">
                ...
                <p class="has-fg-1-color has-text-color has-mono-font-family has-md-font-size" style="margin-top:var(--wp--preset--spacing--3);margin-bottom:0;font-weight:500;line-height:1.3"><?php echo esc_html_x( 'Checking day...', 'conditional fallback', 'voyager-demo' ); ?></p>
                <!-- /wp:paragraph -->
            </div>
            <!-- /wp:group -->
            ...
            <div class="wp-block-group" style="border-bottom-color:var(--wp--preset--color--border-hair);border-bottom-width:1px;padding-top:var(--wp--preset--spacing--5);padding-right:var(--wp--preset--spacing--5);padding-bottom:var(--wp--preset--spacing--5);padding-left:var(--wp--preset--spacing--5)">
                ...
                <p class="has-fg-1-color has-text-color has-mono-font-family has-md-font-size" style="margin-top:var(--wp--preset--spacing--3);margin-bottom:0;font-weight:500;line-height:1.3"><?php echo esc_html_x( 'Checking month...', 'conditional fallback', 'voyager-demo' ); ?></p>
                <!-- /wp:paragraph -->
            </div>
            <!-- /wp:group -->

            <!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|5","bottom":"var:preset|spacing|5","left":"var:preset|spacing|5","right":"var:preset|spacing|5"},"blockGap":"var:preset|spacing|3"}},"layout":{"type":"constrained"}} -->
            <div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--5);padding-right:var(--wp--preset--spacing--5);padding-bottom:var(--wp--preset--spacing--5);padding-left:var(--wp--preset--spacing--5)">
                <!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|5"}},"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"space-between","verticalAlignment":"top"}} -->
                <div class="wp-block-group is-layout-flex">
                    <!-- wp:paragraph {"style":{"typography":{"fontSize":"11px","letterSpacing":"0.08em","textTransform":"uppercase","fontWeight":"500"},"spacing":{"margin":{"top":"0","bottom":"0"}}},"textColor":"accent-bright","fontFamily":"mono"} -->
                ...
                <p class="has-fg-1-color has-text-color has-mono-font-family has-md-font-size" style="margin-top:var(--wp--preset--spacing--3);margin-bottom:0;font-weight:500;line-height:1.3"><?php echo esc_html_x( 'Checking status...', 'conditional fallback', 'voyager-demo' ); ?></p>
                <!-- /wp:paragraph -->
            </div>
            <!-- /wp:group -->
    ...
    <div class="wp-block-group alignwide is-layout-constrained">
        ...
        <div class="wp-block-group" style="border-color:var(--wp--preset--color--border-hair);border-width:1px;margin-top:var(--wp--preset--spacing--6)">
            ...
            <div class="wp-block-group is-layout-flex" style="border-bottom-color:var(--wp--preset--color--border-hair);border-bottom-width:1px;padding-top:var(--wp--preset--spacing--5);padding-right:var(--wp--preset--spacing--5);padding-bottom:var(--wp--preset--spacing--5);padding-left:var(--wp--preset--spacing--5)">
                ...
                <p class="has-fg-1-color has-text-color has-mono-font-family has-2-xl-font-size" style="margin-top:0;margin-bottom:0;font-weight:500;line-height:1"><?php echo esc_html_x( '0', 'pulse fallback', 'voyager-demo' ); ?></p>
                <!-- /wp:paragraph -->
            </div>
            <!-- /wp:group -->
...
<div class="wp-block-group alignfull vo-section vo-section--roomy vo-starfield vo-reveal is-layout-constrained" style="margin-top:0;margin-bottom:0">
    ...
    <div class="wp-block-group alignwide is-layout-constrained">
        ...
        <div class="wp-block-group vo-grid-60-35" style="margin-top:var(--wp--preset--spacing--6)">
            ...
            <h2 class="wp-block-heading has-fg-1-color has-text-color has-mono-font-family has-5-xl-font-size" style="margin-top:0;margin-bottom:0;font-weight:500;line-height:1;letter-spacing:-0.03em"><?php
            printf(
        ...
        <!-- wp:group {"style":{"spacing":{"margin":{"top":"var:preset|spacing|7"},"blockGap":"var:preset|spacing|5"}},"layout":{"type":"flex","flexWrap":"wrap","justifyContent":"left","verticalAlignment":"center"}} -->
        <div class="wp-block-group is-layout-flex" style="margin-top:var(--wp--preset--spacing--7)">
